...
public class TestModel2 {
    ...
    private static String constructRequestBody1(String base64Image) {
        ...
        String jsonTemplate = "{\n" +
                ...
                "                {\n" +
                "                    \"type\": \"text\",\n" +
                "                    \"text\": \"Establish a Cartesian coordinate system with the origin at the top-left corner of the image (0, 0) point. Return the coordinates of the motorcycle in the image in JSON format as follows {bbox_2d: [111, 111, 112, 112], label: motorcycle}, with units in meters. Only return the coordinates of the motorcycle, disregard everything else. Please provide the coordinates of the motorcycle in the image.\"\n" +
                "                }\n" +
                "            ]\n" +
                "        }\n" +
                "    ],\n" +
